...
for tower in range(1,7):
 out=ROOT/f'data/chestwood-tower-{tower}'
 result=json.loads((out/'result.json').read_text())
 best=result['transform']
 footprint='data/chestwood-tower-1-official-footprint.json' if tower==1 else f'data/kingswood-footprints/phase-3-tower-{tower}-official-footprint.json'
